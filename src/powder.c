...
static int eval_move(int pt, int nx, int ny, unsigned *rr)
{
	...
	if(pt==PT_LASR&&((r&0xFF)==PT_GLAS||(r&0xFF)==PT_LASR||(r&0xFF)==PT_CLNE||((r&0xFF)==PT_LCRY&&parts[r>>8].life > 5)))//Mod
    ...
    if((pt==PT_NEUT ||pt==PT_PHOT) && bmap[ny/CELL][nx/CELL]==WL_EWALL && !emap[ny/CELL][nx/CELL])
        return 0;
	if((pt==PT_NEUT ||pt==PT_LASR) && bmap[ny/CELL][nx/CELL]==7 && !emap[ny/CELL][nx/CELL])//Mod
        return 0;
                ...
                for(nx=-2; nx<3; nx++)
                    for(ny=-2; ny<3; ny++)
                                ...
                                x+nx<XRES && y+ny<YRES && (nx || ny))
                        {
                            ...
                            else if((r&0xFF)!=PT_CLNE&&(r&0xFF)!=PT_THDR&&(r&0xFF)!=PT_SPRK&&(r&0xFF)!=PT_DMND&&(r&0xFF)!=PT_FIRE&&(r&0xFF)!=PT_NEUT&&(r&0xFF)!=PT_PHOT&&(r&0xFF)!=PT_LASR&&(r&0xFF))//Mod
                            {
